...
\definecolor{grassgreen}{RGB}{124, 252, 0}
\definecolor{shamrockgreen}{RGB}{0, 158, 96}
\definecolor{peargreen}{RGB}{201, 204, 63}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=.6]
        ...
        \path (R11) edge[-,>=stealth',shorten >=1pt,auto,draw=gray,line width=1.5pt, fill=gray, opacity=1] node[anchor=center, fill=none] {$\alpha_{{\color{blueind}\bullet}{\color{grassgreen}\bullet}}$} (B1);
        \path (R11) edge (B2);
        \path (R11) edge  (B3);
        \path (R11) edge  (B4);
        ...
        \path (R13) edge  (B2);
        \path (R13) edge  (B3);
        \path (R13) edge[-,>=stealth',shorten >=1pt,auto,draw=gray,line width=1.5pt, fill=gray, opacity=1] node[anchor=center, fill=none] {$\alpha_{{\color{blueind}\bullet}{\color{shamrockgreen}\bullet}}$} (B4);

        \path (R21) edge[-,>=stealth',shorten >=1pt,auto,draw=gray,line width=1.5pt, fill=gray, opacity=1] node[anchor=center, fill=none] {$\alpha_{{\color{cyanind}\bullet}{\color{shamrockgreen}\bullet}}$} (B3);
        \path (R21) edge  (B4);
        \path (R21) edge  (B5);
        
        \path (R22) edge  (B3);
        \path (R22) edge  (B4);
        \path (R22) edge[-,>=stealth',shorten >=1pt,auto,draw=gray,line width=1.5pt, fill=gray, opacity=1] node[anchor=center, fill=none] {$\alpha_{{\color{cyanind}\bullet}{\color{peargreen}\bullet}}$} (B5);

        \path (R31) edge[-,>=stealth',shorten >=1pt,auto,draw=gray,line width=1.5pt, fill=gray, opacity=1] node[anchor=center, fill=none] {$\alpha_{{\color{orangeorg}\bullet}{\color{peargreen}\bullet}}$} (B5);

    \end{tikzpicture}
\caption[LBMvisu]{An LBM model visualization}
\end{figure}
